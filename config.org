...
#+END_SRC
** Dired
Sort files and directories by different criteria (Doesn't work in MacOS)
...
Always copy and delete directories recursively
#+BEGIN_SRC emacs-lisp :tangle yes
(setq dired-recursive-copies (quote always)) ; "always" means no asking
(setq dired-recusive-deletes (quote top)) ; "top" means ask once
#+END_SRC
** Skeleton Code
#+BEGIN_SRC emacs-lisp :tangle yes
(require 'skeleton)
